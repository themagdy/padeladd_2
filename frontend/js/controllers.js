                ...
                <div style="background:${bg}; border:${border}; box-shadow:${boxShadow}; border-radius:14px; padding:14px 16px; display:flex; align-items:center; gap:14px; opacity:${opacity}; transition:all 0.3s; position:relative; overflow:hidden;">
                    ...
                    <div style="flex:1; min-width:0;">
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:8px; margin-bottom:2px;">
                            ...
                            ${isUnlocked ? `<span style="font-size:11px; font-weight:800; color:#4ade80; background:rgba(74,222,128,0.15); padding:3px 9px; border-radius:8px; border:1px solid rgba(74,222,128,0.3); display:inline-flex; align-items:center; gap:4px;" title="Unlocked">🔑 ${item.val !== undefined ? item.val : ''}</span>` : `<span style="font-size:11px; font-weight:800; color:#fff; background:rgba(255,255,255,0.08); border:1px solid rgba(255,255,255,0.15); padding:3px 9px; border-radius:8px; letter-spacing:0.5px;">${valDisplay}</span>`}
                        </div>
