...
const StatsUI = {
    ...
    update: function (stats, prefix) {
        ...
        if (matchesSubEl && stats.matches_played > 0) {
            ...
            matchesSubEl.innerHTML = safeHTML(`<span style="color:var(--c-orange);"><span style="font-size:15px; vertical-align:-1px; margin-right:6px;">🏆</span>${compCount}</span> <span style="opacity:0.5; margin:0 6px;">|</span> <span style="color:#5B8BFF;"><span style="font-size:18px; vertical-align:-2px; margin-right:6px;">🤝</span>${friendlyCount}</span>`);
