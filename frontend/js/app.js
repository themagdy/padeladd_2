...
const StatsUI = {
    ...
    update: function (stats, prefix) {
        ...
        if (matchesSubEl && stats.matches_played > 0) {
            ...
            matchesSubEl.innerHTML = safeHTML(`<span style="color:var(--c-orange);">🏆 ${compCount}</span> <span style="opacity:0.6; margin:0 4px;">|</span> <span style="color:#5B8BFF;">🤝 ${friendlyCount}</span>`);
